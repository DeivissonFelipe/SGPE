...
{!! Breadcrumbs::render('departamentoId', $departamento) !!}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
			<div class="box box-primary-ufop">
	            ...
	            <form role="form" action="/departamentos/{{ $departamento->id }}" method="post"> 
	            	{{ method_field('PATCH') }}
					{{ csrf_field() }}
	              	<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="sigla" id="sigla" value="{{ $departamento->sigla }}" />
						</div><!-- end form-group -->
					</div><!-- end box-body -->
