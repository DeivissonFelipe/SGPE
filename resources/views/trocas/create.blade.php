...
{!! Breadcrumbs::render('nsubstituicao') !!}
		...
		<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			<div class="box box-primary-ufop">
	            <div class="box-header with-border">
	              <h3 class="box-title">Substituição de dia Letivo</h3>
	            </div><!-- end box-header with-border -->
	            <form role="form" action="/trocas" method="post"> 
					{{ csrf_field() }}
	              	<div class="box-body">
                        ...
                        <div id="container-ajaxTransition">
							<div class="form-group">
								...
								<div class="input-group" data-provide="datepicker">
									...
									<input type="text" class="form-control pull-right date datepicker-me" id="dia" name="dia">
								</div><!-- end input-group -->
							</div><!-- end form-group -->
						</div>
